	...
	render: function() {
			return (<form  ref='signin'  className="signin-form"  onSubmit={this.handleSubmit} >
				...
				{this.props.flash}
					...
					<div className="col-xs-6 "  ><BootstrapButton role="button" onClick={this.resetemail} ref="resetbutton" bsStyle='info' disabled={Common.showButton(this.state.valid)}  data-loading-text="Checking..." >  {Text.btns.resetpass} </BootstrapButton></div> 
